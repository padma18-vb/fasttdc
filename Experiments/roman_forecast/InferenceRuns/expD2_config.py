...
# file locations
static_dv_file = 'InferenceRuns/expD2/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/expD2/LCDM_infOM_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
...
likelihood_configs = {
    ...
    # roman quads with aperture kin, UPGRADED with Roman imaging (~10 lenses)
    'roman_aper_quads':{
        ...
        'cosmo_model':COSMO_MODEL,
        'td_meas_error_percent':None,
        'td_meas_error_days':2., # 2-Day ROMAN/LSST TD PREC. (B2 only)
        'kappa_ext_meas_error_value':0.05,
        'kinematic_type':'MUSE',

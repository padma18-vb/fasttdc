...
# file locations
static_dv_file = 'InferenceRuns/expD3/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/expD3/LCDM_infOM_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
...
likelihood_configs = {
    ...
    'roman_aper_quads':{
        ...
        'cosmo_model':COSMO_MODEL,
        'td_meas_error_percent':None,
        'td_meas_error_days':1., # 1-Day ROMAN/LSST TD PREC. (B3 only)
        'kappa_ext_meas_error_value':0.05,
        'kinematic_type':'MUSE',
    ...
    # roman dbls with aperture kin (40 lenses)
    'roman_aper_dbls':{

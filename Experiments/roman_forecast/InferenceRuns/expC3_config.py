...
# path for dv file
static_dv_file = 'InferenceRuns/expC3/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/expC3/LCDM_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
...
likelihood_configs = {
    ...
    'roman_aper_quads':{
        ...
        'cosmo_model':COSMO_MODEL,
        'td_meas_error_percent':None,
        'td_meas_error_days':1., # 3-Day LSST Meas. Precision
        'kappa_ext_meas_error_value':0.05,

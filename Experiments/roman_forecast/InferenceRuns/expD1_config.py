...
# file locations
static_dv_file = 'InferenceRuns/expD1/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
quads_05perc_h5_file = 'DataVectors/lsst_catalog/from_sherlock/quad_posteriors_05percfpd.h5' # ROMAN
...
BACKEND_PATH = 'InferenceRuns/expD1/LCDM_infOM_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
...
likelihood_configs = {
    ...
    'tdcosmo_quads':{
        'posteriors_h5_file':quads_03perc_h5_file,
    ...
    # roman aperture quads (modification: every Roman lens gets IFU)
    'roman_aper_quads':{
        ...
        'cosmo_model':COSMO_MODEL,
        'td_meas_error_percent':None,
        'td_meas_error_days':3., # 3-Day ROMAN/LSST TD PREC. (B2 only)
        'kappa_ext_meas_error_value':0.05,
        'kinematic_type':'MUSE',
        'kin_meas_error_percent':0.03, # 3% MUSE (3 bins)
        'kin_meas_error_kmpersec':None,
        'num_gaussianized_samps':NUM_FPD_SAMPS,
        'lens_params_nu_int_means':mu_lp_gold,
        'lens_params_nu_int_stddevs':stddev_lp_gold,
    ...
    # quads without kinematics (modification: every Roman lens gets IFU)
    'roman_only_quads':{
        'posteriors_h5_file':quads_05perc_h5_file, # UPGRADE TO 5% fpd
        'metadata_file':lsst_metadata_file,
    ...
    # doubles with kinematics (modification: every Roman lens gets IFU)
    'roman_aper_dbls':{
    ...
    # doubles with no kinematics (modification: every Roman lens gets IFU)
    'roman_only_dbls':{
        'posteriors_h5_file':dbls_05perc_h5_file, # UPGRADE TO 5% fpd
        'metadata_file':lsst_metadata_file,

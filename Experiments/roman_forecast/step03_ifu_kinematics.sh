...
python3 galkin_ifu_sherlock_script.py --lens_idx=$1 --h5_posteriors_path=/scratch/users/sydney3/forecast/darkenergy-from-LAGN/Experiments/roman_forecast/DataVectors/lsst_catalog/quad_posteriors_03percfpd.h5

...
def main(args):
    ...
    MUSE_c_sqrtJ_samps = np.empty((n_fpd_samps,3))
    NIRSPEC_c_sqrtJ_samps = np.empty((n_fpd_samps,10))
    ...
    for fp_idx in range(0,n_fpd_samps):
        ...
        # MUSE
        muse_csqrtJ = galkin_utils.ground_truth_ifu_c_sqrtJ(
        ...
        MUSE_c_sqrtJ_samps[fp_idx] = muse_csqrtJ
